...
var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},d.offsetBottom&&(d.offset.bottom=d.offsetBottom),d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);function include(a){document.write('<script src="js/'+a+'"></script>');return false}var currentYear=(new Date).getFullYear();$(document).ready(function(){$("#copyright-year").text((new Date).getFullYear())});include("device.min.js");include("superfish.js");include("jquery.mousewheel.min.js");include("jquery.simplr.smoothscroll.min.js");$(function(){if($("html").hasClass("desktop")){$.srSmoothscroll({step:150,speed:800})}});include("stellar/jquery.stellar.js");$(document).ready(function(){if($("html").hasClass("desktop")){$.stellar({horizontalScrolling:false,verticalOffset:0})}});include("jquery.ui.totop.js");$(function(){$().UItoTop({easingType:"easeOutQuart"})});jQuery(function(){jQuery(".sf-menu").mobileMenu()});$(function(){var a=document.querySelector&&document.querySelector('meta[name="viewport"]'),b=navigator.userAgent,c=function(){a.content="width=device-width, minimum-scale=0.25, maximum-scale=1.6, initial-scale=1.0"},d=function(){if(a&&/iPhone|iPad/.test(b)&&!/Opera Mini/.test(b)){a.content="width=device-width, minimum-scale=1.0, maximum-scale=1.0";document.addEventListener("gesturestart",c,false)}};d();if(window.orientation!=undefined){var e=/ipod|ipad|iphone/gi,f=b.match(e);if(!f){$(".sf-menu li").each(function(){if($(">ul",this)[0]){$(">a",this).toggle(function(){return false},function(){window.location.href=$(this).attr("href")})}})}}});var ua=navigator.userAgent.toLocaleLowerCase(),regV=/ipod|ipad|iphone/gi,result=ua.match(regV),userScale="";if(!result){userScale=",user-scalable=0"}document.write('<meta name="viewport" content="width=device-width,initial-scale=1.0'+userScale+'">');$(window).load(function(){var a;if((a=$(".js-search")).length>0){$(a).find(".toggle").click(function(){if($(".js-search").hasClass("active")){$(".js-search").removeClass("active")}else{$(".js-search").addClass("active")}})}});
//# sourceMappingURL=layout.server.view.4.min.js.map